...
jQuery("#gs-group-messages-base-tab-1 a").click(b)}jQuery(window).load(function(){gsJsLoader.with_module("/++resource++gs-search-base-js-min-20131121.js",gs_group_messages_posts_init_search)
});